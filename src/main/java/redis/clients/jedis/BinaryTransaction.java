...
public class BinaryTransaction extends Queable {
	 ...
	 * @return
	 */
	public Response<Map<String, String>> ldbIterForwardsKeys(byte[] key,
			long count) {
	 ...
	 * @return
	 */
	public Response<Set<String>> ldbIterForwardsKeysAndValues(byte[] key,
			long count) {
	...
	public Response<Boolean> setbit(final byte[] key, final long offset,
			final byte[] value) {
		client.setbit(key, offset, value);
		return getResponse(BuilderFactory.BOOLEAN);
	}
